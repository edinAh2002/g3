    ...
    Scaffold(
        bottomBar = {
            NavigationBar {
                ...
                NavigationBarItem(
                    selected = currentScreen == AppScreen.Sleep,
                    onClick = {
                        currentScreen = AppScreen.Sleep
                    },
                    label = { Text("Sleep") },
                    icon = { Text("🌙") }
                )
                ...
                NavigationBarItem(
                    selected = currentScreen == AppScreen.MoodLog ||
                            currentScreen == AppScreen.MoodTracking,
                    onClick = {
                        currentScreen = AppScreen.MoodLog
                    },
                    label = { Text("Mood") },
                    icon = { Text("🙂") }
                )
